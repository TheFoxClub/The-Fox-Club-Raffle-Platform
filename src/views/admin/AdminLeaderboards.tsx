              ...
              <table className="w-full">
                ...
                <tbody>
                  {topHosts.map((host, index) => (
                    <tr key={host.wallet} className="border-b border-border/30 hover:bg-muted/20">
                      <td className="p-4">
                        <div className="flex items-center gap-3">
                          <div
                          ...
                          {index < 3 && <Trophy className="h-4 w-4 text-accent" />}
                        </div>
                      </td>
                      <td className="p-4 font-medium">{host.wallet}</td>
                      <td className="p-4 text-primary font-bold">{host.revenue}</td>
                      <td className="p-4 text-muted-foreground">{host.raffles}</td>
                      <td className="p-4">
                      ...
                      <td className="p-4">
                        <span className="text-accent font-medium">🔥 {host.streak} days</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {topBuyers.map((buyer, index) => (
                    <tr key={buyer.wallet} className="border-b border-border/30 hover:bg-muted/20">
                      <td className="p-4">
                        <div className="flex items-center gap-3">
                          <div
                            className={`h-10 w-10 rounded-full flex items-center justify-center font-bold ${
                      ...
                      <td className="p-4 text-accent font-bold">{buyer.spending}</td>
                      <td className="p-4 text-muted-foreground">{buyer.tickets}</td>
                      <td className="p-4">
                      ...
                      <td className="p-4">
                        <span className="text-accent font-medium">🔥 {buyer.streak} days</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
